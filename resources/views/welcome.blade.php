        ...
        <div id="container">
            <div id="form-container">
                <div id="form-header">
                 ...
                 <div id="form">
                    <form method="post">
                        <div style="display:flex; flex-direction:column; justify-content: space-around; height:70px; margin:15px">
                        ...
                        <div id="form-b1">
                          ...
                          <div style="display:flex;">
                            <button button type="submit" style="height: 35px; align-self:flex-end;" class="btn btn-send">
                            
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-lg" viewBox="0 0 16 16">
                                    <path d="M12.736 3.97a.733.733 0 0 1 
